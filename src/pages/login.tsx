...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 px-4 text-gray-900 dark:text-white">
      ...
      >
        <h2 className="text-3xl font-extrabold text-center text-indigo-700 dark:text-yellow-400">Welcome Back!</h2>
        <p className="text-gray-600 dark:text-gray-300 text-center mt-2">Login to continue</p>
        ...
        <form onSubmit={handleLogin} className="mt-6 space-y-4">
          ...
          <div className="relative w-full">
            <input
              ...
              required
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:outline-none pr-10"
            />
            <button
              type="button"
        ...
        <p className="text-center text-gray-600 dark:text-gray-300 mt-4">
          ...
          <Link to="/signup" className="text-indigo-600 dark:text-yellow-400 font-semibold hover:underline">
            Register Here!
          </Link>
        </p>
      </motion.div>
