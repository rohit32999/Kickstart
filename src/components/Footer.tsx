      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-2">For sponsorships & partnerships:</p>
            <p className="text-indigo-600 dark:text-indigo-400 flex items-center gap-2">
        ...
        <div className="mt-12 bg-gray-200 dark:bg-gray-800 p-6 rounded-lg text-center">
        ...
        {/* Footer Bottom */}
        <div className="mt-8 border-t border-gray-300 dark:border-gray-700 pt-8 md:flex md:items-center md:justify-between">
